                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('تقييم 4.7', style: TextStyle(color: Colors.black54, fontSize: 16)),
                          SizedBox(width: 12),
                          Text('● متوفر', style: TextStyle(color: Color(0xFF22A06B), fontWeight: FontWeight.w700, fontSize: 16)),
                        ],
                      ),
                      const SizedBox(height: 10),
                      ...
                      const Divider(),
                      const SizedBox(height: 10),
                      const Text('الوصف', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 30)),
                      const SizedBox(height: 6),
                      Text(p.subtitle, style: const TextStyle(color: Colors.black54, height: 1.5, fontSize: 28)),
                      const SizedBox(height: 16),
                      const Text('المزايا', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 30)),
                      const SizedBox(height: 10),
                      const Row(
                        children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text('إضافة إلى السلة • ${p.price.toStringAsFixed(2)} ر.ع', style: const TextStyle(fontWeight: FontWeight.w800)),
                      ),
                    ),
                  )
                ],
